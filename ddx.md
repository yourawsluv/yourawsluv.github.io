...
<img width="600" height="auto" alt="image" src="https://github.com/user-attachments/assets/c2543e98-1798-4e17-8022-35a0b00d2267" />
...
Выделенная команда ML-инженеров помогала решать задачи продуктов. Был PoC и опыт сокращения нагрузки на операторов через внедрение LLM в продукт мобильного приложения, через персонального ИИ-помощника, интегрированного с CRM.
...
Чат-платформа является омниканальным продуктом - объединяет клиентов DDX Fitness (мобильное приложение, веб-сайт, соц. сети) и тренеров DDX Coach.
