...
>Я **T-shaped** проектировщик, развиваю экспертизу в продуктах — от выявления **UserStory**, до внедрения **инструментов DevEx** и **DesignOps**. Могу выстраивать процессы и менторить. Работаю на одном языке с **Аналитиками, PM, BDM, Frontend, QA,** и конечно же с **пользователями**:)
...
**[Ambersoft](https://ambersoft.llc/) | Dubai, UAE | 01.2024 — 10.2024**
...
### Product Designer
**[NeuroCity](https://www.neuro-city.ru/) | Moscow, Russia | 06.2022 — 01.2024**
...
### Graphic Designer
**[Экспедиция](https://explip.ru/) | Moscow, Russia | 03.2021 — 06.2022**

- Вёрстка цифрового контента и печатной продукции (Научная литература).
- Брендирование и создание шаблонов.
- Разработка и поддержка веб-сайта компании.
- Создание дизайн-системы на платформе совместной работы.
- Отрисовка чертежей, проектирование, сведение планов, оцифровка карт.
- Копирайтинг и обработка текстовой информации, подготовка к публикации.
- Координирование смежных и младших сотрудников. Обучение  и контроль качества.
