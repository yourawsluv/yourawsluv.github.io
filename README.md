...
>5+ лет в продуктах B2B, SaaS, Fintech. T-shaped экспертиза — от проведения CustDev в MVP, до оптимизации процессов в успешном бизнесе. Работаю на одном языке с A/B, ML, BizDev, Frontend, QA, и конечно же с юзерами:)

## 🔭 Ключевые навыки

- Управление продуктом: Backlog, CJM, User Stories, приоритизация задач.
- Аналитика и метрики: Сбор данных, A/B тесты, Tableau, сводные таблицы.
...
- Автоматизация: Оптимизация процессов через AI-сервисы.
...
### Principal Designer / Product Manager
...
- Разработал ряд графических концептов для ключевых рекламных кампаний компании.  
