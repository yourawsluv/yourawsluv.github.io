...
# Запуск нового модуля для управления купле-продажи запчастей

**Компания:** Рольф автодилерский холдинг
**Продукт:** [ERP-система Flora](https://www.rolftech.ru/flora)
...
Спроектировать модуль, который покрывает полный цикл продажи запчастей — от потребности клиента до закрытой сделки и возвратов.
