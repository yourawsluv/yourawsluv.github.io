...
**Цель проекта:** спроектировать модуль ERP, который покрывает полный цикл продажи запчастей — от потребности клиента до закрытой сделки и возвратов.

---

## 2. Моя роль и зона ответственности

Я выступал как **Product Designer**, работающий на стыке UX, бизнес‑анализа и системного проектирования.
...
## 3. Пользователи и контекст использования

### Ключевые роли

1. **Менеджер по продажам запчастей** — основной пользователь, работает с заказами и клиентами.
2. **Сотрудник склада** — отвечает за резервы, выдачу и возвраты.
...
* использование на планшетах в зоне склада.
...
> Основная боль не в интерфейсе, а в отсутствии **единого сквозного объекта**, который связывает заказ, склад и финансы.

Таким объектом стал **ДКПЗ**, формируемый на основе заказа покупателя.
