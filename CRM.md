...
## **Качественные метрики которые выделили для продукта**
...
## **Проблема и глобальная гипотеза**
...
### **Проектирование и доставка (4 месяца)**
...
- **TargetAI (пролонгация)** результат коммуникации с клиентом, рекомендаций по коммуникации, прогнозирование оттока
...
### Дизайн-система 250+ компонентов
